...
<script type="text/javascript" src="scripts/hoverZoom.js"></script>
	...
	<p class="main-text cen-col">Unless otherwise stated, all design and front-end code (HTML, CSS, JavaScript, etc.) on these projects were created from scratch by me, back-end/custom CMS by my mates from <strong><a href="http://mixart.do">Mixart</a></strong>. Click on project names to view their details.</p>

	<section class="proj-wrap empire transTh">
	...
	<section class="proj-wrap sdv transTh">
	...
	<section class="proj-wrap pekepolis transTh">
...
<script>
	...
	proj.click(function(event){
		...
		if(!current_proj.hasClass('active')){
			...
			var prev_projH = prev_proj.children().height();
			
			if(current_proj.index() < prev_proj.index()){
				prev_projH = 36;
			}
			
			var proj_offset = current_proj.offset().top - 50 - prev_projH;
